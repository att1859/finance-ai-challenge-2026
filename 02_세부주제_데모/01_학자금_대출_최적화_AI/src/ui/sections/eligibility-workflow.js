...
export function renderEligibilityWorkflow(state) {
 ...
 <label class="eligibility-review"><input type="checkbox" name="eligibilityReviewed" ${flow.reviewed?'checked':''} ${error?'aria-invalid="true" aria-describedby="eligibility-reviewed-error"':''}><span>기본값과 체크하지 않은 항목을 포함해 위 내용을 확인했습니다.</span></label>
